...
@Component({
  template: '<button [ngpToggle]="pressed" [ngpToggleDisabled]="disabled" (ngpTogglePressedChange)="onToggle($event)">Toggle</button>',
})
class TestComponent {
...
describe('NgpToggleDirective', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [TestComponent, NgpToggleDirective],
    }).compileComponents();
  });

...
You can use the `ng generate @ng-primitives/avatar:component` schematic to generate a new avatar component.

<CodeGroup>

```bash Angular CLI
ng generate @ng-primitives/avatar:component
```

```bash Nx
nx generate @ng-primitives/avatar:component
```

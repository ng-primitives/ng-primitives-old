...
```bash npm
npm i @ng-primitives/radio
```

```bash yarn
yarn add @ng-primitives/radio
```
...
<ResponseField name="ngpRadioGroupOrientation" type="'vertical' | 'horizontal'" default="horizontal">
...
```bash Angular CLI
ng generate @ng-primitives/schematics:radio
```

```bash Nx
nx generate @ng-primitives/schematics:radio
```
